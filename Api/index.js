...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://jaktharry-app.netlify.app', 'https://jaktharry-app.netlify.app'); // Allow all origins (replace with specific origins if needed)
